...
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. Enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
...
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
...
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l jobs -d '`install` runs up to this many formula installations in parallel. Defaults to 1 (sequential). Use `auto` for the number of CPU cores (max 4)'
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. Enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_arg 'bundle; and [ (count (__fish_brew_args)) = 1 ]' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
...
__fish_brew_complete_sub_arg 'bundle' 'upgrade' -l jobs -d '`install` runs up to this many formula installations in parallel. Defaults to 1 (sequential). Use `auto` for the number of CPU cores (max 4)'
__fish_brew_complete_sub_arg 'bundle' 'upgrade' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'upgrade' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'upgrade' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l check -d 'Check that all dependencies in the Brewfile are installed before running `exec`, `sh`, or `env`. Enabled by default if `$HOMEBREW_BUNDLE_CHECK` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'sh' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l no-secrets -d 'Attempt to remove secrets from the environment before `exec`, `sh`, or `env`. Enabled by default if `$HOMEBREW_BUNDLE_NO_SECRETS` is set'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'sh' -l services -d 'Temporarily start services while running the `exec` or `sh` command. Enabled by default if `$HOMEBREW_BUNDLE_SERVICES` is set'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l cargo -d '`list`, `dump` or `cleanup` Cargo packages'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l cask -d 'Add Homebrew cask entries'
...
__fish_brew_complete_sub_arg 'bundle' 'remove' -l flatpak -d '`list`, `dump` or `cleanup` Flatpak packages. Note: Linux only'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l formula -d 'Add Homebrew formula entries'
...
__fish_brew_complete_sub_arg 'bundle' 'remove' -l go -d '`list`, `dump` or `cleanup` Go packages'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l krew -d '`list` or `dump` Krew plugins'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l npm -d '`list`, `dump` or `cleanup` npm packages'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l tap -d 'Add Homebrew tap entries'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l uv -d '`list`, `dump` or `cleanup` uv tools'
__fish_brew_complete_sub_arg 'bundle' 'remove' -l vscode -d '`list`, `dump` or `cleanup` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'list' -l all -d '`list` all dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l cargo -d '`list`, `dump` or `cleanup` Cargo packages'
__fish_brew_complete_sub_arg 'bundle' 'list' -l cask -d 'Add Homebrew cask entries'
...
__fish_brew_complete_sub_arg 'bundle' 'list' -l flatpak -d '`list`, `dump` or `cleanup` Flatpak packages. Note: Linux only'
__fish_brew_complete_sub_arg 'bundle' 'list' -l formula -d 'Add Homebrew formula entries'
...
__fish_brew_complete_sub_arg 'bundle' 'list' -l go -d '`list`, `dump` or `cleanup` Go packages'
__fish_brew_complete_sub_arg 'bundle' 'list' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'list' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'list' -l krew -d '`list` or `dump` Krew plugins'
__fish_brew_complete_sub_arg 'bundle' 'list' -l mas -d '`list` or `dump` Mac App Store dependencies'
__fish_brew_complete_sub_arg 'bundle' 'list' -l npm -d '`list`, `dump` or `cleanup` npm packages'
__fish_brew_complete_sub_arg 'bundle' 'list' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'list' -l tap -d 'Add Homebrew tap entries'
__fish_brew_complete_sub_arg 'bundle' 'list' -l uv -d '`list`, `dump` or `cleanup` uv tools'
__fish_brew_complete_sub_arg 'bundle' 'list' -l vscode -d '`list`, `dump` or `cleanup` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'install' -l cleanup -d '`install` performs cleanup operation, same as running `cleanup --force`. Enabled by default if `$HOMEBREW_BUNDLE_INSTALL_CLEANUP` is set and `--global` is passed'
...
__fish_brew_complete_sub_arg 'bundle' 'install' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
...
__fish_brew_complete_sub_arg 'bundle' 'install' -l jobs -d '`install` runs up to this many formula installations in parallel. Defaults to 1 (sequential). Use `auto` for the number of CPU cores (max 4)'
__fish_brew_complete_sub_arg 'bundle' 'install' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. Enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'install' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'install' -l upgrade -d '`install` runs `brew upgrade` on outdated dependencies, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'install' -l upgrade-formulae -d '`install` runs `brew upgrade` on any of these comma-separated formulae, even if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'install' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l check -d 'Check that all dependencies in the Brewfile are installed before running `exec`, `sh`, or `env`. Enabled by default if `$HOMEBREW_BUNDLE_CHECK` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'exec' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l no-secrets -d 'Attempt to remove secrets from the environment before `exec`, `sh`, or `env`. Enabled by default if `$HOMEBREW_BUNDLE_NO_SECRETS` is set'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'exec' -l services -d 'Temporarily start services while running the `exec` or `sh` command. Enabled by default if `$HOMEBREW_BUNDLE_SERVICES` is set'
__fish_brew_complete_sub_arg 'bundle' 'exec' -a '(__fish_brew_suggest_commands)'
__fish_brew_complete_sub_arg 'bundle' 'env' -l check -d 'Check that all dependencies in the Brewfile are installed before running `exec`, `sh`, or `env`. Enabled by default if `$HOMEBREW_BUNDLE_CHECK` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'env' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'env' -l no-secrets -d 'Attempt to remove secrets from the environment before `exec`, `sh`, or `env`. Enabled by default if `$HOMEBREW_BUNDLE_NO_SECRETS` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'edit' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'edit' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l cargo -d '`list`, `dump` or `cleanup` Cargo packages'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l cask -d 'Add Homebrew cask entries'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l describe -d '`dump` and `add` add a description comment above each line, unless the dependency does not have a description. Enabled by default if `$HOMEBREW_BUNDLE_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'dump' -l flatpak -d '`list`, `dump` or `cleanup` Flatpak packages. Note: Linux only'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l formula -d 'Add Homebrew formula entries'
...
__fish_brew_complete_sub_arg 'bundle' 'dump' -l go -d '`list`, `dump` or `cleanup` Go packages'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l krew -d '`list` or `dump` Krew plugins'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l mas -d '`list` or `dump` Mac App Store dependencies'
...
__fish_brew_complete_sub_arg 'bundle' 'dump' -l no-restart -d '`dump` does not add `restart_service` to formula lines'
...
__fish_brew_complete_sub_arg 'bundle' 'dump' -l npm -d '`list`, `dump` or `cleanup` npm packages'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l tap -d 'Add Homebrew tap entries'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l uv -d '`list`, `dump` or `cleanup` uv tools'
__fish_brew_complete_sub_arg 'bundle' 'dump' -l vscode -d '`list`, `dump` or `cleanup` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l cargo -d '`list`, `dump` or `cleanup` Cargo packages'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l cask -d 'Add Homebrew cask entries'
...
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l flatpak -d '`list`, `dump` or `cleanup` Flatpak packages. Note: Linux only'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l force -d '`install` runs with `--force`/`--overwrite`. `dump` overwrites an existing `Brewfile`. `cleanup` actually performs its cleanup operations'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l formula -d 'Add Homebrew formula entries'
...
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l go -d '`list`, `dump` or `cleanup` Go packages'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l npm -d '`list`, `dump` or `cleanup` npm packages'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l tap -d 'Add Homebrew tap entries'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l uv -d '`list`, `dump` or `cleanup` uv tools'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l vscode -d '`list`, `dump` or `cleanup` VSCode (and forks/variants) extensions'
__fish_brew_complete_sub_arg 'bundle' 'cleanup' -l zap -d '`cleanup` casks using the `zap` command instead of `uninstall`'
...
__fish_brew_complete_sub_arg 'bundle' 'check' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'check' -l no-upgrade -d '`install` does not run `brew upgrade` on outdated dependencies. `check` does not check for outdated dependencies. Note they may still be upgraded by `brew install` if needed. Enabled by default if `$HOMEBREW_BUNDLE_NO_UPGRADE` is set'
__fish_brew_complete_sub_arg 'bundle' 'check' -l quiet -d 'Make some output more quiet'
__fish_brew_complete_sub_arg 'bundle' 'check' -l verbose -d '`install` prints output from commands as they are run. `check` lists all missing dependencies'
__fish_brew_complete_sub_arg 'bundle' 'add' -l cargo -d '`list`, `dump` or `cleanup` Cargo packages'
...
__fish_brew_complete_sub_arg 'bundle' 'add' -l describe -d '`dump` and `add` add a description comment above each line, unless the dependency does not have a description. Enabled by default if `$HOMEBREW_BUNDLE_DESCRIBE` is set'
...
__fish_brew_complete_sub_arg 'bundle' 'add' -l flatpak -d '`list`, `dump` or `cleanup` Flatpak packages. Note: Linux only'
...
__fish_brew_complete_sub_arg 'bundle' 'add' -l go -d '`list`, `dump` or `cleanup` Go packages'
__fish_brew_complete_sub_arg 'bundle' 'add' -l help -d 'Show this message'
__fish_brew_complete_sub_arg 'bundle' 'add' -l install -d 'Run `install` before continuing to other operations, e.g. `exec`'
__fish_brew_complete_sub_arg 'bundle' 'add' -l krew -d '`list` or `dump` Krew plugins'
__fish_brew_complete_sub_arg 'bundle' 'add' -l npm -d '`list`, `dump` or `cleanup` npm packages'
...
__fish_brew_complete_sub_arg 'bundle' 'add' -l uv -d '`list`, `dump` or `cleanup` uv tools'
__fish_brew_complete_sub_arg 'bundle' 'add' -l vscode -d '`list`, `dump` or `cleanup` VSCode (and forks/variants) extensions'
...
__fish_brew_complete_arg 'services; and [ (count (__fish_brew_args)) = 1 ]' -l json -d 'Output as JSON'
...
__fish_brew_complete_sub_arg 'services' 'stop unload terminate term t u' -l all -d 'Run subcommand on all services'
...
__fish_brew_complete_sub_arg 'services' 'start launch load s l' -l all -d 'Run subcommand on all services'
...
__fish_brew_complete_sub_arg 'services' 'run' -l all -d 'Run subcommand on all services'
__fish_brew_complete_sub_arg 'services' 'run' -l debug -d 'Display any debugging information'
__fish_brew_complete_sub_arg 'services' 'run' -l file -d 'Use the service file from this location to `start` the service'
...
__fish_brew_complete_sub_arg 'services' 'restart relaunch reload r' -l all -d 'Run subcommand on all services'
...
__fish_brew_complete_sub_arg 'services' 'kill k' -l all -d 'Run subcommand on all services'
...
__fish_brew_complete_sub_arg 'services' 'info i' -l all -d 'Run subcommand on all services'
...
__fish_brew_complete_arg 'upgrade' -l ask -d 'Ask for confirmation before downloading and upgrading. Print the same plan as `--dry-run`, including available download sizes. Enabled by default if `$HOMEBREW_ASK` is set'
