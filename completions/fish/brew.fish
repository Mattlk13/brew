...
__fish_brew_complete_arg 'bundle' -l cargo -d '`list`, `dump` or `cleanup` Cargo packages'
...
__fish_brew_complete_arg 'bundle' -l npm -d '`list`, `dump` or `cleanup` npm packages'
...
__fish_brew_complete_arg 'bundle' -l uv -d '`list`, `dump` or `cleanup` uv tools'
...
__fish_brew_complete_arg 'instal' -l appimagedir -d 'Target location for AppImages (default: ``)'
...
__fish_brew_complete_arg 'install' -l appimagedir -d 'Target location for AppImages (default: ``)'
...
__fish_brew_complete_arg 'reinstall' -l appimagedir -d 'Target location for AppImages (default: ``)'
...
__fish_brew_complete_arg 'upgrade' -l appimagedir -d 'Target location for AppImages (default: ``)'
